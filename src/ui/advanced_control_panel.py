...
class AdvancedControlPanel:
    ...
    def create_recognition_system_selection(self):
        ...
        self.recognition_var = tk.StringVar(value="improved")
        
        systems = [
            ("Standard", "standard", "Basic template matching"),
            ("Improved", "improved", "Enhanced with color analysis"),
            ("Enhanced", "enhanced", "Color-based suit detection"),
            ("Comprehensive", "comprehensive", "Multi-method with empty slot detection"),
            ("Direct", "direct", "Color + OCR recognition")
        ]
        ...
        # Apply button
        apply_btn = tk.Button(
            recognition_frame, text="Apply Recognition System",
            command=self.apply_recognition_system,
